...
setup(
    name="django-url-permissions",  # Replace with your package name
    ...
    url="https://github.com/jmarxuach/django-url-permissions",  # Project URL
    project_urls={
        "Bug Tracker": "https://github.com/jmarxuach/django-url-permissions/issues",  # Issue tracker
    },
    classifiers=[
